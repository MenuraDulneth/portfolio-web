  ...
  return (
    <Magnetic>
      <a
        ...
        className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full whitespace-nowrap font-medium uppercase tracking-widest text-sm text-white transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(124,58,237,0.5)]"
        style={{
